...
class Lab1_Comunicaciones(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_Comunicaciones")
        ...
        self._Amplitud_range = Range(0, 5, 0.1, 0, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, frequency, Amplitud, 0, 0)
...
def main(top_block_cls=Lab1_Comunicaciones, options=None):
